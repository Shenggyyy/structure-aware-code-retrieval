...
Strategy: `hybrid`; evaluation unit: `symbol`.
...
Warm retrieval: p50 55.161 ms; p95 373.142 ms.
...
Warm retrieval: p50 55.084 ms; p95 181.704 ms.
...
Warm retrieval: p50 285.488 ms; p95 431.936 ms.
...
Warm retrieval: p50 26.284 ms; p95 35.025 ms.
...
Warm retrieval: p50 71.561 ms; p95 194.736 ms.
...
Warm retrieval: p50 25.894 ms; p95 33.803 ms.
...
Warm retrieval: p50 55.577 ms; p95 355.334 ms.
...
Warm retrieval: p50 56.371 ms; p95 381.344 ms.
...
Warm retrieval: p50 54.020 ms; p95 362.031 ms.
...
Warm retrieval: p50 54.941 ms; p95 396.726 ms.
