...
Choose the embedding model after local memory, inference-time, and quality checks in
M4. Select formal repositories after license, snapshot, and annotation-feasibility
